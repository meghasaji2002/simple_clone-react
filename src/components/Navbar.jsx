...
<>
     ...
     <div style={{width:'100%',height:'80px',padding:'0px 10px', display:'flex',alignItems:'center',backgroundColor:'black'}} >
          ...
          <h6 style={{color:'white',marginLeft:'20px'}}>Home</h6>
          <h6 style={{color:'white',marginLeft:'15px'}}>TV Shows</h6>
         <h6 style={{color:'white',marginLeft:'15px'}}>Movies</h6>
          <h6 style={{color:'white',marginLeft:'15px'}}>Kids</h6>
        ...
        <div  style={{display:'flex',alignItems:'center',justifyContent:'center'}}> 
         <div style={{border:'1px solid white',borderRadius:'5px'}}  ><i style={{color:'gray',fontSize:'18px'}} class="fa-solid fa-magnifying-glass ms-2 "></i><input className=' rounded ps-2 ms-2  ' style={{height:'30px',background:'transparent',border:'0'}}  placeholder='Search' type="text" /></div>
           ...
           <div style={{height:'35px',width:'35px',borderRadius:'50%',border:'1px solid white',display:'flex',alignItems:'center',justifyContent:'center',marginLeft:'10px'}}><i class="fa-solid fa-user" style={{color:'gray',fontSize:'20px'}}></i></div>
  
           <NavDropdown className='ms-2 ' style={{color:'white'}} title="Profile" id="basic-nav-dropdown">
